...
contract IContentsManager {
    ...
    function addContents(address _writer, string _record, uint256 _marketerRate) external;
    ...
    event RegisterContents(uint256 indexed _contentsIndexId, address indexed _contentsAddress, address indexed _writerAddress, string _record, uint256 _marketerRate);
}
