...
contract IContentsManager {
    ...
    function addContents(address _writer, string _writerName, string _record, bool _isPublished, uint256 _publishDate) external;
    ...
    event RegisterContents(uint256 indexed _contentsIndexId, address indexed _contentsAddress, address indexed _writerAddress, string _writerName, string _record, bool _isPublished, uint256 _publishDate);
}
