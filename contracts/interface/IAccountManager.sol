...
contract IAccountManager {
    ...
    function isRegisteredUserName(string _userName) public view returns (bool isRegistered_);
    function isRegisteredWallet(address _wallet) public view returns (bool isRegistered_);
    function isRegisteredPrivateKey(string _privateKey) public view returns (bool isRegistered_);
