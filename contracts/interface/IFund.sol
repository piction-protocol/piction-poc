...
interface IFund {
    ...
    function info() external view returns (uint256 startTime_, uint256 endTime_, uint256[] memory limit_, uint256 fundRise_, uint256 poolSize_, uint256 releaseInterval, uint256 distributionRate, uint256 supportFirstTime_, string detail);
